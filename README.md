...
- Takes user input
- Prints variety of characteristics
- Prints power range in a statement
- Prints names
- Gives error if user input is over 20
- Gives error if user input is 0 or under
...
When the program has been initiated, it will ask the user for the amount of NPC's they would like to generate. Once you proceed to enter the number, if above 20, you will be prompted with an error, if 0 or below, you will be prompted with an error. If entered in the correct range <u>(1-20)</u>, You will be prompted with the amount of NPCs requested. From here the program will stop.
